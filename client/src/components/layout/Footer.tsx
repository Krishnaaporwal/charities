      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-foreground">Developer API</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-foreground">Blockchain Explorer</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-foreground">Press Kit</a></li>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} CryptoFund. All rights reserved.</p>
